...
class Window(tk.Toplevel):
    def __init__(self, parent):
        ...
        plot1.plot(
            ...
            graph1,
            color="#00FFFF",
            label="températures minimales en Isère en 2018",
        )
        plot1.plot(
            range(len(datetime_dates)),
            graph2,
            color="#FF8300",
            label="températures maximales en Isère en 2018",
        )
        plot1.plot(
            range(len(datetime_dates)), graph3, color="#0000FF", label="Limite 0°C"
        )
        plot1.plot(
            range(len(datetime_dates)), graph4, color="#FF0000", label="Limite 30°C"
        )
